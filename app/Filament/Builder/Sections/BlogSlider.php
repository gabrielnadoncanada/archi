...
class BlogSlider extends SectionBuilder
{
    protected static string $name = 'blog_slider';
            ...
            ->schema([
                Group::make([
                    ...
                    TextInput::make('title')
                        ->default('Design Insights & Inspiration'),
                    Textarea::make('description')
                        ->default('Unveil the Secrets to Transforming Spaces')
                        ->columnSpanFull(),
                ])->columns(),
            ]);
    }
